 ...
 * initViews() method.
 */
public class SideHorizontalScrollView extends HorizontalScrollView {
	public SideHorizontalScrollView(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public SideHorizontalScrollView(Context context) {
		super(context);
		init(context);
	}
	...
	class MyOnGlobalLayoutListener implements OnGlobalLayoutListener {
		...
		public void onGlobalLayout() {
			...
			final HorizontalScrollView me = SideHorizontalScrollView.this;
