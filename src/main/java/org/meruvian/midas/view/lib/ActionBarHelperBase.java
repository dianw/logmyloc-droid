...
import org.meruvian.midas.util.GlobalVariable;
...
public class ActionBarHelperBase extends ActionBarHelper {
	...
	private void setupActionBar() {
		...
		String globalVariableTitle = GlobalVariable.getGlobalVariableByKey(
				mActivity, "default.title");
		titleText.setText(globalVariableTitle != "" ? globalVariableTitle
				: mActivity.getTitle());
		actionBarCompat.addView(titleText);
	}

	@Override
	public void setActionBarIcon(int actionbarResource) {
		this.actionBarIcon = actionbarResource;
	}
